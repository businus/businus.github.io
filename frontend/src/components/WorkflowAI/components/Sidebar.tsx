...
interface SidebarProps {
  ...
  onAiAddNode: (prompt: string) => Promise<void>;
}
...
const AiNodeCreator: React.FC<{ onAiAddNode: (prompt: string) => Promise<void> }> = ({ onAiAddNode }) => {
...
export const Sidebar: React.FC<SidebarProps> = ({ onAddNode, onAiAddNode }) => {
  const [searchTerm, setSearchTerm] = useState('');
  const [favoriteNodes, setFavoriteNodes] = useState<NodeType[]>(() => {
    try {
